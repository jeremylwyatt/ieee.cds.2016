...
This constraint is applied per triangle in the mesh.  Since Teschner and Morris \comment{%\sout{didn't find it helpful to add damping to the preservation of areas, it is avoided here.} 

...
% The paper headers
\markboth{IEEE Transactions on Systems, Man, and Cybernetics—Part B: Cybernetics,
...
\end{align}
where $\vec{v}_j$ is the velocity of the $j^{th}$ particle connected to $i$, in a system with $n$ particles.

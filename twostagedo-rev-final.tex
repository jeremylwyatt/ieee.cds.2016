...
\end{align}
where $\varphi$ is the angle between adjacent edges,% $E_\varphi$ is the energy associated with changes in the angle, $k_\varphi$ is the corresponding stiffness constant, 
